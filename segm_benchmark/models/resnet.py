...
__all__ = ['resnet50', 'resnet101', 'BasicBlock', 'Bottleneck']


_CKPT = {
    "resnet50": "work_dirs/pretrained/resnet50-ebb6acbb.pth",
    "resnet101": "work_dirs/pretrained/resnet101-2a57e44d.pth"
}
...
def resnet50(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.load(_CKPT['resnet50']), strict=False)
    return model
...
def resnet101(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.load(_CKPT['resnet101']), strict=False)
    return model
